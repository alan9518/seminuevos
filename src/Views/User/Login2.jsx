    ...
    renderRegisterForm() {
        ...
        if(isAgency) {
            let registerFields = [
                ...
                {inputName : 'ms-pass', inputType : 'password', inputPlaceholder : 'Contraseña' },
                {inputName : 'ms-agencyName', inputType : 'text', inputPlaceholder : 'Nombre de la Agencia' }
        ...
        // const agencyField = 
        // isAgency === true ? registerFields.push(agencyField) :  registerFields.pop(agencyField);
        return (
